...
public class CalcTest {
  ...
  @Test
  @DisplayName("20 + 20 + 30 == 70")
  void t8() {
    assertThat(Calc.run("20 + 20 + 30")).isEqualTo(70);
  }
  ...
  @Test
  @DisplayName("3 * (10 + 20) == 90")
  void t25() {
    assertThat(Calc.run("3 * (10 + 20)")).isEqualTo(90);
  }
